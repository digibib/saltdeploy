...
# # run opac
# KOHA_CONF=/etc/koha/sites/{{ pillar['koha']['instance'] }}/koha-conf.xml PERL5LIB=/usr/share/koha/lib plackup --reload /usr/share/koha/opac.psgi

# # run intranet
# KOHA_CONF=/etc/koha/sites/{{ pillar['koha']['instance'] }}/koha-conf.xml PERL5LIB=/usr/share/koha/lib plackup --reload --port 5001 /usr/share/koha/intranet.psgi
